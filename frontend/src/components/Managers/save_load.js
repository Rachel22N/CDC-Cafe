...
import { CardMedia, Grid, ThemeProvider, AppBar, Toolbar, Typography, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Button, Card, CardContent, Icon, } from '@mui/material';
      ...
      <div className='background-login'>
        ...
        >
          <Grid container spacing={0} sx={{  
            ...
            {menus.map((menu) => (
                // edit card height and width
              <Card key={menu.MenuItemID} sx={{ 
